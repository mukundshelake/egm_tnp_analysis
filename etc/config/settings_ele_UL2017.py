...
flags = {
    ...
    'passHLTEle30eta2p1WPTightGsf' : '(passHLTEle30eta2p1WPTightGsf == 1)',
    'passCentralPFJet35EleCleaned' : '(passCentralPFJet35EleCleaned == 1)',
    'passHltEle35WPTightGsf' : '(passHltEle35WPTightGsf == 1)',
    'SLFandLX_branch' : '(SLFandLX_branch == 1)'
    }

baseOutDir = 'results/UL2017/tnpEleTrig/'
...
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/eos/user/m/mshelake/ScaleFactorCalc/PileupWeights/UL2017/DY_amcatnloext_ele.pu.puTree.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/eos/user/m/mshelake/ScaleFactorCalc/PileupWeights/UL2017/DY_madgraph_ele.pu.puTree.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/eos/user/m/mshelake/ScaleFactorCalc/PileupWeights/UL2017/DY_amcatnloext_ele.pu.puTree.root')
